            ...
            <div className="flex-1 overflow-hidden p-3 sm:px-5 sm:pb-5 sm:pt-3">
                <div className="mx-auto grid h-full w-full max-w-7xl gap-3 xl:grid-cols-[minmax(0,1fr)_320px]">
                    <div className="flex min-w-0 min-h-0 flex-col gap-3">
                        ...
                        <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-[32px] border border-slate-200 bg-white/85 shadow-[0_24px_80px_-60px_rgba(15,23,42,0.4)] backdrop-blur">
                            ...
                            <div className="shrink-0 border-t border-slate-100 bg-white/90 p-4 backdrop-blur sm:px-5">
                                <div className="mb-3 px-1">
                                    <div className="group relative mb-1 flex items-center justify-between">
                                        <div className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-tight text-slate-400">
                                            ...
                                            <div className="invisible absolute bottom-full left-0 mb-2 rounded-lg bg-slate-900 px-3 py-2 text-[10px] whitespace-nowrap text-white opacity-0 shadow-xl transition-all duration-200 group-hover:visible group-hover:opacity-100">
