...
export default function ComparisonKpiGrid({ chart, compact = false }: ComparisonKpiGridProps) {
              ...
              <div className="min-w-0">
                ...
                <div className="mt-2 flex flex-wrap items-end gap-x-3 gap-y-1">
                  ...
                  <div className="text-[11px] font-bold text-neutral-500">
                    ...
                    <span className="tabular-nums">{formatValue(row.kind, row.previous, true)}</span>
                  </div>
                </div>
              </div>
