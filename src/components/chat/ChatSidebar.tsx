...
export default function ChatSidebar({ sessions, user }: ChatSidebarProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 left-0 z-50 transform w-72 bg-neutral-900 border-r border-neutral-800 flex flex-col h-full text-neutral-300 transition-transform duration-300 ease-in-out md:relative md:translate-x-0 ${
