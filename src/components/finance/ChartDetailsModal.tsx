                                    ...
                                    <div className="grid gap-3 lg:grid-cols-2">
                                        <div className="space-y-3">
                                            <div className="rounded-2xl bg-blue-50/70 p-4">
                                                <p className="text-[11px] font-black uppercase tracking-[0.18em] text-blue-700">O que este gráfico mostra</p>
                                        ...
                                        <div className="space-y-3">
                                            <SectionList icon={<Sigma className="h-4 w-4" />} title="Como é calculado" items={entry.detail.calculation} />
                                            <SectionList icon={<Database className="h-4 w-4" />} title="Origem das informações" items={entry.detail.dataSources} />
