...
export const dashboardThemes: Record<DashboardThemeKey, DashboardTheme> = {
    ...
    payable: {
        ...
        chartPalette: ["#f97316", "#2563eb", "#16a34a", "#eab308", "#7c3aed", "#0ea5e9", "#a16207"],
        primary: "#f97316",
        strong: "#ea580c",
    },
    receivable: {
        ...
        chartPalette: ["#16a34a", "#2563eb", "#f59e0b", "#7c3aed", "#0ea5e9", "#84cc16", "#64748b"],
        primary: "#16a34a",
        strong: "#15803d",
    },
    cashflow: {
        ...
        chartPalette: ["#2563eb", "#16a34a", "#f59e0b", "#7c3aed", "#0ea5e9", "#64748b", "#ef4444"],
        primary: "#2563eb",
        strong: "#1d4ed8",
    },
    analysis: {
        ...
        chartPalette: ["#7c3aed", "#2563eb", "#16a34a", "#f59e0b", "#0ea5e9", "#a855f7", "#64748b"],
        primary: "#7c3aed",
        strong: "#6d28d9",
    },
    efficiency: {
