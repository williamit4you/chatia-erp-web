...
import { PlusCircle, MessageSquare, LogOut, Settings, MoreVertical } from "lucide-react";
...
export default function ChatSidebar({ sessions, user }: ChatSidebarProps) {
    return (
        <div className="w-72 bg-neutral-900 border-r border-neutral-800 flex flex-col h-full text-neutral-300">
            {/* New Chat Button */}
            <div className="p-4">
                <Link
                    href="/chat"
