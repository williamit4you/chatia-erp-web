                                        ...
                                        <tr key={tenant.id} className="hover:bg-neutral-800/50 transition-colors">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex gap-2">
                                                    <span className={`inline-flex items-center px-2 py-1 rounded text-xs font-medium ${tenant.iaToken ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'}`} title="Token Memória RAG">
                                                        RAG
                                                    </span>
                                                    <span className={`inline-flex items-center px-2 py-1 rounded text-xs font-medium ${tenant.chatAiToken ? 'bg-blue-500/10 text-blue-400 border border-blue-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'}`} title="Token IA p/ Consulta e Chat">
                                                        CHAT
                                                    </span>
                                                    <span className={`inline-flex items-center px-2 py-1 rounded text-xs font-medium ${tenant.erpToken ? 'bg-amber-500/10 text-amber-400 border border-amber-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'}`} title="Token ERP / Bearer">
                                                        ERP
                                                    </span>
                                                </div>
                                            </td>
